...
path = os.path.join(current_path, "biomedical-datasets", "JNLPBA-eval")
save_path = os.path.join(current_path, "instruction-datasets", "ner", "JNLPBA-eval")

dataset = ds.load_from_disk(path)
index_to_label = {0: 'I', 1: 'O', 2: 'B'}
